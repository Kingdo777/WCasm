...
byte read_U8(vm *v, instruction *inst) {
    byte buf;
    uint64 offset = ((memArgs *) inst->arg)->offset;
...
byte read_U16(vm *v, instruction *inst) {
    uint16_t buf;
    uint64 offset = ((memArgs *) inst->arg)->offset;
...
byte read_U32(vm *v, instruction *inst) {
    uint32 buf;
    uint64 offset = ((memArgs *) inst->arg)->offset;
...
byte read_U64(vm *v, instruction *inst) {
    uint64 buf;
    uint64 offset = ((memArgs *) inst->arg)->offset;
...
void write_U8(vm *v, instruction *inst, byte buf) {
    uint64 offset = ((memArgs *) inst->arg)->offset;
...
void write_U16(vm *v, instruction *inst, uint16_t buf) {
    uint64 offset = ((memArgs *) inst->arg)->offset;
...
void write_U32(vm *v, instruction *inst, uint32 buf) {
    uint64 offset = ((memArgs *) inst->arg)->offset;
...
void write_U64(vm *v, instruction *inst, uint64 buf) {
    uint64 offset = ((memArgs *) inst->arg)->offset;
